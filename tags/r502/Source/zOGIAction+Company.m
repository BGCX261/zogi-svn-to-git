                               ...
                               forCompany:(id)_objectId
{
  ...
  address = [[NSMutableDictionary alloc] initWithObjectsAndKeys:
                ...
                [self NIL:[_address objectForKey:@"zip"]], @"zipcity",
                             ...
                             forCompany:(id)_objectId
{
  ...
  phone = [[NSMutableDictionary alloc] initWithObjectsAndKeys:
              [_phone objectForKey:@"info"], @"info",
              [_phone objectForKey:@"number"], @"number",
        ...
        forEntity:(NSString *)_entity
{
  ...
  for (count = 0; count < [keys count]; count++) 
  {
    ...
    if (key != nil)
      [company setObject:[_company objectForKey:[keys objectAtIndex:count]]
                  forKey:key];
  ...
  {
    if ([self isDebug])
      [self logWithFormat:@"Performing update of %@", [company objectForKey:@"companyId"]];
