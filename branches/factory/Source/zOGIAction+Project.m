         ...
         withFlags:(NSArray *)_flags 
{
  ...
  [self logWithFormat:@"_writeProject with command %@", _command];
  [self logWithFormat:@"_writeProject project = %@", project];
  ...
  if ([project class] == [NSException class]) 
  {
    ...
    [self logWithFormat:@"project write Logic failed with exception"];
    return project;
  }
  [self logWithFormat:@"project write Logic executed"];
