...
task['_PROPERTIES'] = [ property1, property2 ]
...
#task['_OBJECTLINKS'] = [ link ]
task['_OBJECTLINKS'].append(link)
property1 = {}
property1['propertyName'] = '{http://www.whitemiceconsulting.com/properties/ext-attr}myIntAttribute'
property1['value'] = 12
property2 = {}
property2['propertyName'] = '{http://www.whitemiceconsulting.com/properties/ext-attr}Dude'
property2['value'] = 'Yoyo Mama'
task['_PROPERTIES'] = [ property1, property2 ]
...
print "--Archive--"
notation['comment'] = ('Archive %d' % task['objectId'])
notation['action'] = 'archive'
print server.zogi.putObject(notation);
...
print "--Delete--"
print server.zogi.deleteObject(task['objectId'])
